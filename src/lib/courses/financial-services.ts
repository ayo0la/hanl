...
export const financialServicesSubcategories: CourseSubcategory[] = [
  {
    name: "AI & Automation Courses",
    courses: [
      {
        name: "AI-Driven Credit Risk Assessment & Scoring",
        isNew: true,
      },
      {
      ...
      {
        name: "Automated Fraud Detection Systems",
        isNew: true,
      },
      {
      ...
      {
        name: "Machine Learning for AML Compliance",
        isNew: true,
      },
      {
        name: "Predictive Analytics for Banking",
        isNew: true,
      },
    ],
  },
  {
    ...
    courses: [
      ...
      {
        name: "Cards, Digital and Internet Services",
      },
      {
        name: "Credit Suite – Commercial, Small Business, Consumer",
      },
      {
        name: "Domestic Banking Operations",
      },
      {
      ...
      {
        name: "Microfinancing: Micro Savings and Micro Credits",
      },
      {
